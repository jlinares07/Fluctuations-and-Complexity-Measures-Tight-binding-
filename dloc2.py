...
evolution = qt.sesolve(H, psi0, t_list, options = options)
#H_dense = H.full()  # Usar solo para N pequeño o análisis específico de dimensiones
#H.unit() es necesario? Está normalizada en teoria
...
np.savez(f"Delocalized_v2,U={U},V0={V0}.npz", t_list=t_list, entropies=entropies, desequilibria=desequilibria, complexities=complexities, currents = currents, cm=cm, linear_entropy=linear_entropy, complex_sdl=complex_sdl)
